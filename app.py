...
# --- تعديل دالة الجرد لتصبح مرنة مع كلمة "تم" ---
def calculate_live_stock(rep_name):
    ...
    try:
        ...
        # التعديل هنا: يبحث عن كلمة "تم" فقط ليكون أسهل عليك بالإدخال
        ...
        # التأكد من وجود عمود المندوب قبل الفلترة لتجنب الخطأ الأحمر
