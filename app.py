...
# --- استبدل السطرين اللذين وجدتهما بهذا الكود بالكامل ---
if not st.session_state.logged_in:
    # 1. كود CSS لتثبيت الشاشة وسحب اللوجو للأعلى
    st.markdown("""
        <style>
            .main { overflow: hidden !important; } /* تجميد الحركة */
            .block-container {
                padding-top: 0rem !important; /* إلغاء الفراغ العلوي */
                padding-bottom: 0rem !important;
            }
        </style>
    """, unsafe_allow_html=True)

    # 2. عرض اللوجو داخل الشرط
